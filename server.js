    ...
    'article-three':{
        ...
        content:`
                    ...
                    <h2> Vehicle Surveillance and Monitoring System</h2><br>
                        <p7>A vehicle security device based on raspberry pi2 with intruder alert, navigation and <br>facial recognition system. A device which is independent of the vehicle's inbuilt mechanism<br> to provide high end security at theft prone areas and also provide help in case of emergency <br> to the users. Moreover, nobody has time to keep check on the worker who is doing the job of cleaning<br> a vehicle, even if we keep check, it is not possible to do that every day. <br>So, here is a system which can not only keep check on the security of the vehicle but also act as<br> a multipurpose tool to monitor the cleaner of the vehicle. </p7><br><br>
