    ...
    'article-three':{
        ...
        content:`
                    ...
                    <h2> Line Follower Robot </h2><br>
                        ...
                        <p7>Constructed an automatic robot that is capable of traversing on black line with white <br> track using ATMEL 89C51.</p7><br><br>
                    ...
                    <h2>Rash Driving Warning System For Highway Police</h2><br>
                        <p7>Constructed a system with help of 555 timer & multi-vibrator to detect the high speed <br>of vehicles on highway. Basically a speed limit detector  for traffic police to catch <br> high speed vehicles with a fixed specified speed limit set by the police rules.</p7><br><br>
                      
                    <h2>Line follower Hovercraft  </h2><br>
                        <p7>A hovercraft, basically an air cushion vehicle used  for rough terrains be it in water <br> or land. Working with the help of light detectors which follow white line on a black surface with multiple <br> air propellers using embedded system Microcontroller 89C51.</p7><br><br>
                        
                    <h2> Vehicle Surveillance and Monitoring System</h2><br>
                        <p7>A vehicle security device based on raspberry pi2 with intruder alert, navigation and facial <br>recognition system. A device which is independent of the vehicle's inbuilt mechanism to provide high end security at theft prone areas and also provide help in case of emergency to the users. Moreover, nobody has time to keep check on the worker who is doing the job of cleaning a vehicle, even if we keep check, it is not possible to do that every day. So, here is a system which can not only keep check on the security of the vehicle but also act as a multipurpose tool to monitor the cleaner of the vehicle. </p7><br><br>
                        
                    <h2> Data Visualization of Disaster Information Retrieval Based on Social Media </h2><br>
                        <p7>Study of Data Visualization tools for disaster information retrieval via social media and find out the best suited visualization such that that information can be extracted immediately and concerned authorities may take necessary steps in case of emergency.</p7><br><br>
